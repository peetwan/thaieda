...
def build_dirty_thai(path: Path) -> int:
    ...
    names = [
        "สมชาย ใจดี", "สมหญิง รักไทย", "วิชัย มั่นคง", "นภา สดใส", "ประพันธ์ ทองคำ",
        "กนกพร แสงเดือน", "ธนา พงษ์ไทย", "ศิริพร บุญมา", "อนันต์ วงศ์ใหญ่", "มาลี ดอกไม้",
    ]
...
def build_clean_thai(path: Path) -> int:
    ...
    names = [
        "สมชาย ใจดี", "สมหญิง รักไทย", "วิชัย มั่นคง", "นภา สดใส", "ประพันธ์ ทองคำ",
        "กนกพร แสงเดือน", "ธนา พงษ์ไทย", "ศิริพร บุญมา", "อนันต์ วงศ์ใหญ่", "มาลี ดอกไม้",
        "ชัยวัฒน์ เจริญสุข", "ปรียา ทองแท้",
    ]
