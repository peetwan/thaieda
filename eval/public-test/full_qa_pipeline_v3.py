...
DATASETS = [
    ...
    # --- New 5 (from UCI / reliable sources) ---
    {"name": "absenteeism", "file": "Absenteeism_at_work.csv", "domain": "workplace absenteeism", "has_dates": False, "has_text": True, "has_thai": False, "sep": ";"},
    {"name": "online-shoppers", "file": "online-shoppers.csv", "domain": "online shopping intention", "has_dates": False, "has_text": True, "has_thai": False},
    {"name": "aps-failure", "file": "aps-failure-clean.csv", "domain": "truck diagnostics", "has_dates": False, "has_text": False, "has_thai": False},
    {"name": "beijing-pm25", "file": "beijing-pm25.csv", "domain": "air quality", "has_dates": True, "has_text": True, "has_thai": False},
    {"name": "bike-sharing", "file": "bike-sharing-hour.csv", "domain": "bike sharing", "has_dates": True, "has_text": True, "has_thai": False},
]
...
def main():
    ...
    print("\n" + "=" * 60, flush=True)
    print("  QA SUMMARY v3", flush=True)
    print("=" * 60, flush=True)
