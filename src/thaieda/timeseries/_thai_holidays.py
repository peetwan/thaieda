...
_MOVABLE_HOLIDAY_RANGES: list[dict[str, any]] = [
    ...
    {"name": "วันอาสาฬหบูชา", "month": 7, "day_start": 1, "day_end": 31},
    {"name": "วันเข้าพรรษา", "month": 7, "day_start": 1, "day_end": 31},
    {"name": "วันอนุสรณ์สถานสันติภาพ", "month": 8, "day_start": 1, "day_end": 31},
    {"name": "วันพืชมงคล", "month": 5, "day_start": 1, "day_end": 31},
]
